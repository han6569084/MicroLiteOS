...
/*部分液晶信号线的引脚复用编号是AF9*/
#define GPIO_AF14_LTDC_AF9          ((uint8_t)0x09)
...
#define LTDC_VSYNC_GPIO_CLK       GPIOI
...
#define LTDC_DISP_GPIO_CLK         GPIOD
